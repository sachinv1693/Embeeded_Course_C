...
;;  wait2           2   18[COMRAM] unsigned short 
;;  wait1           2   16[COMRAM] unsigned short 
...
;main.c: 27: unsigned short wait2;
...
l667:
;main.c: 34: {
;main.c: 35: key_detected = 0;
	bcf	(_key_detected/8),c,(_key_detected)&7
	line	36
;main.c: 36: RB6 = !RB6;
	btfss	c:(31758/8),(31758)&7	;volatile
	goto	u31
	goto	u30
u31:
...
l671:
;main.c: 51: for (wait2 = 50000; wait2--; );
	movlw	high(0C350h)
