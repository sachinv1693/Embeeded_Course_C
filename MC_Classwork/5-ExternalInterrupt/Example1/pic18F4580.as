...
??_main:	; 1 bytes @ 0xE
	global	main@once
main@once:	; 2 bytes @ 0xE
	ds   2
	global	main@wait2
main@wait2:	; 4 bytes @ 0x10
	ds   4
	global	main@wait1
main@wait1:	; 2 bytes @ 0x14
	ds   2
;!
;!Data Sizes:
;!    Strings     0
...
;;  wait2           4   16[COMRAM] unsigned long 
;;  wait1           2   20[COMRAM] unsigned short 
;;  once            2   14[COMRAM] unsigned short 
...
l661:
;main.c: 26: unsigned short wait1;
;main.c: 27: unsigned long int wait2;
;main.c: 28: unsigned short once = 1;
	movlw	high(01h)
	movwf	((c:main@once+1)),c
	movlw	low(01h)
	movwf	((c:main@once)),c
	line	30
	
l663:
;main.c: 30: init_config();
...
l665:
;main.c: 33: {
;main.c: 35: if (key_detected)
	btfss	(_key_detected/8),c,(_key_detected)&7
	goto	u21
	goto	u20
u21:
	goto	l669
...
l669:
;main.c: 39: }
;main.c: 53: for (wait1 = 50000; wait1--; );
	movlw	high(0C350h)
...
l675:
	decf	((c:main@wait2)),c
	movlw	0
	subwfb	((c:main@wait2+1)),c
	subwfb	((c:main@wait2+2)),c
	subwfb	((c:main@wait2+3)),c
		incf	((c:main@wait2)),c,w
	bnz	u61
	incf	((c:main@wait2+1)),c,w
	bnz	u61
	incf	((c:main@wait2+2)),c,w
	bnz	u61
	incf	((c:main@wait2+3)),c,w
	btfss	status,2
	goto	u61
	goto	u60
...
l653:
;main.c: 17: init_external_interrupt();
