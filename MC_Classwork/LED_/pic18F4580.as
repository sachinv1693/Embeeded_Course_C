...
main@i:	; 2 bytes @ 0x8
	ds   2
	global	main@i_36
main@i_36:	; 2 bytes @ 0xA
	ds   2
	global	main@i_37
main@i_37:	; 2 bytes @ 0xC
	ds   2
;!
;!Data Sizes:
;!    Strings     0
...
;;  i               2   12[COMRAM] volatile int 
;;  i               2   10[COMRAM] volatile int 
;;  i               2    8[COMRAM] volatile int 
;;  count           2    6[COMRAM] int 
;;  period          2    3[COMRAM] int 
...
l679:
;main.c: 19: int count = 0, period = 1000;
	movlw	high(0)
	movwf	((c:main@count+1)),c
	movlw	low(0)
	movwf	((c:main@count)),c
	movlw	high(03E8h)
	movwf	((c:main@period+1)),c
	movlw	low(03E8h)
	movwf	((c:main@period)),c
	line	21
...
l683:
;main.c: 23: {
;main.c: 24: key = read_digital_keypad(0);
	movlw	(0)&0ffh
	
	call	_read_digital_keypad
	movwf	((c:main@key)),c
	line	25
;main.c: 25: if (key == 0x0E)
		movlw	14
...
l685:
;main.c: 26: {
;main.c: 27: if (count < 1000)
	btfsc	((c:main@count+1)),c,7
	goto	u70
	movlw	232
	subwf	 ((c:main@count)),c,w
	movlw	3
	subwfb	((c:main@count+1)),c,w
	btfsc	status,0
	goto	u71
	goto	u70
...
l691:
;main.c: 31: {
;main.c: 32: if (count > 0)
	btfsc	((c:main@count+1)),c,7
	goto	u91
	movf	((c:main@count+1)),c,w
	bnz	u90
	decf	((c:main@count)),c,w
	btfss	status,0
	goto	u91
	goto	u90
...
l697:
;main.c: 36: for (volatile int i = count; i--;);
	movff	(c:main@count),(c:main@i)	;volatile
	movff	(c:main@count+1),(c:main@i+1)	;volatile
	goto	l699
...
l699:
	decf	((c:main@i)),c	;volatile
	btfss	status,0
	decf	((c:main@i+1)),c	;volatile
		incf	((c:main@i)),c,w	;volatile
	bnz	u101
	incf	((c:main@i+1)),c,w	;volatile
	btfss	status,2
	goto	u101
	goto	u100
...
l701:
;main.c: 38: for (volatile int i = period - count; i--;);
	movff	(c:main@count),??_main+0+0
	movff	(c:main@count+1),??_main+0+0+1
	comf	(??_main+0+0),c
	comf	(??_main+0+1),c
	infsnz	(??_main+0+0),c
	incf	(??_main+0+1),c
	movf	((c:main@period)),c,w
	addwf	(??_main+0+0),c,w
	movwf	((c:main@i_36)),c	;volatile
	movf	((c:main@period+1)),c,w
	addwfc	(??_main+0+1),c,w
	movwf	1+((c:main@i_36)),c	;volatile
	goto	l703
...
l703:
	decf	((c:main@i_36)),c	;volatile
	btfss	status,0
	decf	((c:main@i_36+1)),c	;volatile
		incf	((c:main@i_36)),c,w	;volatile
	bnz	u111
	incf	((c:main@i_36+1)),c,w	;volatile
	btfss	status,2
	goto	u111
	goto	u110
...
l705:
;main.c: 39: for (volatile int i = 50000; i--;);
	movlw	high(-15536)
	movwf	((c:main@i_37+1)),c	;volatile
	movlw	low(-15536)
	movwf	((c:main@i_37)),c	;volatile
	goto	l707
...
l707:
	decf	((c:main@i_37)),c	;volatile
	btfss	status,0
	decf	((c:main@i_37+1)),c	;volatile
		incf	((c:main@i_37)),c,w	;volatile
	bnz	u121
	incf	((c:main@i_37+1)),c,w	;volatile
	btfss	status,2
	goto	u121
	goto	u120
