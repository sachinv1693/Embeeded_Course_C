...
TOSU equ 0FFFh ;# 
	...
	FNCALL	_main,_non_blocking_led_train
	FNROOT	_main
	global	blocking_led_train@i
	global	non_blocking_led_train@count
	global	non_blocking_led_train@i
	global	_ADCON1
_ADCON1	set	0xFC1
	global	_PORTB
_PORTB	set	0xF81
...
global __pbssCOMRAM
__pbssCOMRAM:
blocking_led_train@i:
       ds      2
non_blocking_led_train@count:
       ds      2
non_blocking_led_train@i:
       ds      2
	file	"pic18F4580.as"
	line	#
psect	cinit
...
__pcstackCOMRAM:
?_non_blocking_led_train:	; 1 bytes @ 0x0
??_non_blocking_led_train:	; 1 bytes @ 0x0
...
l697:
;main.c: 18: {
;main.c: 24: non_blocking_led_train();
	call	_non_blocking_led_train	;wreg free
	goto	l697
	line	26
...
GLOBAL	__end_of_main
	__end_of_main:
	signat	_main,89
	global	_non_blocking_led_train

;; *************** function _non_blocking_led_train *****************
;; Defined at:
;;		line 5 in file "non_blocking_led_train.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text1
	file	"non_blocking_led_train.c"
	line	5
	global	__size_of_non_blocking_led_train
	__size_of_non_blocking_led_train	equ	__end_of_non_blocking_led_train-_non_blocking_led_train
...
l649:
;non_blocking_led_train.c: 8: static unsigned short count = 0, i = 0;
;non_blocking_led_train.c: 10: if (count++ == 10000)
	infsnz	((c:non_blocking_led_train@count)),c
	incf	((c:non_blocking_led_train@count+1)),c
		movlw	17
	xorwf	((c:non_blocking_led_train@count)),c,w
	bnz	u11
	movlw	39
	xorwf	((c:non_blocking_led_train@count+1)),c,w
	btfss	status,2
	goto	u11
	goto	u10
...
l651:
;non_blocking_led_train.c: 11: {
;non_blocking_led_train.c: 12: count = 0;
	movlw	high(0)
	movwf	((c:non_blocking_led_train@count+1)),c
	movlw	low(0)
	movwf	((c:non_blocking_led_train@count)),c
	line	14
	
l653:
;non_blocking_led_train.c: 14: if (++i == 32)
	infsnz	((c:non_blocking_led_train@i)),c
	incf	((c:non_blocking_led_train@i+1)),c
		movlw	32
	xorwf	((c:non_blocking_led_train@i)),c,w
iorwf	((c:non_blocking_led_train@i+1)),c,w
	btfss	status,2
	goto	u21
	goto	u20
...
l655:
;non_blocking_led_train.c: 15: i = 0;
	movlw	high(0)
	movwf	((c:non_blocking_led_train@i+1)),c
	movlw	low(0)
	movwf	((c:non_blocking_led_train@i)),c
	goto	l657
...
l657:
;non_blocking_led_train.c: 16: }
;non_blocking_led_train.c: 18: if (i > 23)
		movf	((c:non_blocking_led_train@i+1)),c,w
	bnz	u30
	movlw	24
	subwf	 ((c:non_blocking_led_train@i)),c,w
	btfss	status,0
	goto	u31
	goto	u30
...
l659:
;non_blocking_led_train.c: 19: PORTB &= ~(01 << 31 - i);
	movf	((c:non_blocking_led_train@i)),c,w
	sublw	0
	movwf	(??_non_blocking_led_train+0+0)&0ffh,c
	movlw	01Fh
	addwf	((??_non_blocking_led_train+0+0)),c
	movlw	(01h)&0ffh
	movwf	(??_non_blocking_led_train+1+0)&0ffh,c
	incf	((??_non_blocking_led_train+0+0)),c
	goto	u44
u45:
	bcf	status,0
	rlcf	((??_non_blocking_led_train+1+0)),c
u44:
	decfsz	((??_non_blocking_led_train+0+0)),c
	goto	u45
	movf	((??_non_blocking_led_train+1+0)),c,w
	xorlw	0ffh
...
l661:
;non_blocking_led_train.c: 21: else if (i > 15)
		movf	((c:non_blocking_led_train@i+1)),c,w
	bnz	u50
	movlw	16
	subwf	 ((c:non_blocking_led_train@i)),c,w
...
l663:
;non_blocking_led_train.c: 22: PORTB |= (01 << 23 - i);
	movf	((c:non_blocking_led_train@i)),c,w
	sublw	0
	movwf	(??_non_blocking_led_train+0+0)&0ffh,c
	movlw	017h
...
l665:
;non_blocking_led_train.c: 24: else if (i > 7)
		movf	((c:non_blocking_led_train@i+1)),c,w
	bnz	u70
	movlw	8
	subwf	 ((c:non_blocking_led_train@i)),c,w
...
l667:
;non_blocking_led_train.c: 25: PORTB &= ~(01 << i - 8);
	movff	(c:non_blocking_led_train@i),??_non_blocking_led_train+0+0
	movlw	0F8h
	addwf	(??_non_blocking_led_train+0+0),c
	movlw	(01h)&0ffh
	movwf	(??_non_blocking_led_train+1+0)&0ffh,c
...
l669:
;non_blocking_led_train.c: 27: else
;non_blocking_led_train.c: 28: PORTB |= (01 << i);
	movff	(c:non_blocking_led_train@i),??_non_blocking_led_train+0+0
	movlw	(01h)&0ffh
	movwf	(??_non_blocking_led_train+1+0)&0ffh,c
	incf	(??_non_blocking_led_train+0+0),c
...
l34:
	return	;funcret
	opt stack 0
GLOBAL	__end_of_non_blocking_led_train
	__end_of_non_blocking_led_train:
	signat	_non_blocking_led_train,89
	global	_init_config
