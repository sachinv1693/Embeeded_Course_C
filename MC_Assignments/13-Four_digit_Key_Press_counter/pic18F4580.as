...
;initializer for _ssd
	...
	global	_disp_count
	global	_tim_count
	global	read_digital_keypad@key
	global	_TMR0
_TMR0	set	0xFD6
	global	_ADCON1
_ADCON1	set	0xFC1
...
?_main:	; 1 bytes @ 0x0
	ds   14
??_init_ssd_control:	; 1 bytes @ 0xE
??_init_digital_keypad:	; 1 bytes @ 0xE
??_read_digital_keypad:	; 1 bytes @ 0xE
...
read_digital_keypad@detection_type:	; 1 bytes @ 0xE
	global	display@data
display@data:	; 2 bytes @ 0xE
...
l70:
	line	31
;main.c: 29: {
;main.c: 31: if (read_digital_keypad(1) == 0x0E)
	movlw	(01h)&0ffh
...
l998:
;main.c: 36: (inc_flag) ? ++disp_count : inc_flag = 1;
	movf	((c:_inc_flag)),c,w
iorwf	((c:_inc_flag+1)),c,w
	btfsc	status,2
	goto	u341
	goto	u340
...
l1000:
	infsnz	((c:_disp_count)),c
	incf	((c:_disp_count+1)),c
	goto	l1008
...
l1004:
;main.c: 39: else if (read_digital_keypad(0) == 0x0E)
	movlw	(0)&0ffh
...
l1008:
;main.c: 44: if (disp_count > 9999)
		movlw	16
	subwf	 ((c:_disp_count)),c,w
	movlw	39
	subwfb	((c:_disp_count+1)),c,w
	btfss	status,0
	goto	u361
	goto	u360
...
l1010:
;main.c: 45: disp_count = 0;
	movlw	high(0)
	movwf	((c:_disp_count+1)),c
	movlw	low(0)
	movwf	((c:_disp_count)),c
	goto	l1012
...
l1012:
;main.c: 47: { ssd[3] = digit[disp_count % 10]; ssd[2] = digit[(disp_count / 10) % 10]; ssd[1] = digit[(disp_count / 100) % 10]; ssd[0] = digit[disp_count / 1000]; };
	movff	(c:_disp_count),(c:___lwmod@dividend)
	movff	(c:_disp_count+1),(c:___lwmod@dividend+1)
	movlw	high(0Ah)
...
l1014:
	...
	movff	(c:_disp_count),(c:___lwdiv@dividend)
	movff	(c:_disp_count+1),(c:___lwdiv@dividend+1)
...
l782:
;digital_keypad.c: 12: static unsigned char once = 1, key;
...
;digital_keypad.c: 17: once = 0;
	...
	line	18
;digital_keypad.c: 18: return key;
	movf	((c:read_digital_keypad@key)),c,w
	goto	l140
...
l794:
;digital_keypad.c: 20: else if ((PORTC & 0x0F) != 0x0F)
	movf	((c:3970)),c,w	;volatile
	andlw	low(0Fh)
	xorlw	0Fh
	btfsc	status,2
...
l796:
;digital_keypad.c: 21: {
;digital_keypad.c: 22: once = 1;
	movlw	low(01h)
	movwf	((c:read_digital_keypad@once)),c
	line	23
	
l798:
;digital_keypad.c: 23: key = (PORTC & 0x0F);
	movf	((c:3970)),c,w	;volatile
	andlw	low(0Fh)
	movwf	((c:read_digital_keypad@key)),c
	goto	l806
	line	24
...
l806:
;digital_keypad.c: 29: }
;digital_keypad.c: 30: return 0xFF;
	movlw	(0FFh)&0ffh
	goto	l140
...
l776:
;main.c: 12: init_ssd_control();
	call	_init_ssd_control	;wreg free
	line	14
;main.c: 14: init_digital_keypad();
...
l762:
;timer0.c: 25: TMR0IF = 0;
	bcf	c:(32658/8),(32658)&7	;volatile
	line	28
	
l764:
;timer0.c: 28: TMR0IE = 1;
...
l766:
;ssd_display.c: 6: TRISD = 0x00;
	movlw	low(0)
	movwf	((c:3989)),c	;volatile
	line	8
	
l768:
;ssd_display.c: 8: TRISA = TRISA & 0xF0;
...
l770:
;ssd_display.c: 11: PORTA = PORTA & 0xF0;
...
l772:
;digital_keypad.c: 5: ADCON1 = 0x0F;
	movlw	low(0Fh)
...
l938:
;ssd_display.c: 17: unsigned int wait;
;ssd_display.c: 18: unsigned char data_bit;
;ssd_display.c: 19: unsigned char digit;
;ssd_display.c: 21: for (digit = 0; digit < 4; digit++)
	movlw	low(0)
...
l944:
;ssd_display.c: 22: {
;ssd_display.c: 23: PORTD = data[digit];
...
l946:
;ssd_display.c: 24: PORTA = (PORTA & 0xF0) | (0x01 << digit);
...
l948:
;ssd_display.c: 26: for (wait = 1000; wait--; );
	movlw	high(03E8h)
...
;isr.c: 13: TMR0 = TMR0 + 3038;
	...
	line	15
;isr.c: 15: if (tim_count++ == 200)
	infsnz	((c:_tim_count)),c
	incf	((c:_tim_count+1)),c
		movlw	201
	xorwf	((c:_tim_count)),c,w
iorwf	((c:_tim_count+1)),c,w
	btfss	status,2
	goto	i2u17_41
	goto	i2u17_40
...
i2l870:
;isr.c: 16: {
;isr.c: 18: tim_count = 0;
	movlw	high(0)
	movwf	((c:_tim_count+1)),c
	movlw	low(0)
	movwf	((c:_tim_count)),c
	line	19
;isr.c: 19: disp_count = 0;
	movlw	high(0)
	movwf	((c:_disp_count+1)),c
	movlw	low(0)
	movwf	((c:_disp_count)),c
